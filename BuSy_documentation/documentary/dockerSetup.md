...
- que `databases/systemDB.db` siga disponible
- que los archivos en `static/private/systemLogs` sigan actualizandose
...
Los datos siguen viviendo en el proyecto local:

- `databases/systemDB.db`
- `static/private/systemLogs`
